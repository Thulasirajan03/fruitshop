...
function Navbar(){
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
        ...
        <div className={ ` flex md:block justify-end ${open? "block":"hidden"}`}>
            ...
            <li className='nav border-b-4'><a href="#">Fruits</a></li>
            <li className='nav'><a href="#">vegetables</a></li>
            <li className='nav'><a href="#">More</a></li>
            <li><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 text-green-500 w-6 h-10">
