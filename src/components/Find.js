...
<footer class=" w-full py-8">
    <div class="max-w-screen-xl px-4 mx-auto">
        <ul class="flex flex-wrap justify-between max-w-screen-md mx-auto text-lg font-light">
            <li class="my-2">
                <a class="text-gray-400 hover:text-gray-800 dark:text-slate-500 dark:hover:text-green-400 transition-colors duration-200" href="#">
                    Branches
                </a>
            </li>
            <li class="my-2">
        ...
        <div class="pt-8 flex max-w-xs mx-auto items-center justify-between">
            <a href="#" class="text-gray-400 transition-colors duration-200 hover:text-gray-800 dark:hover:text-green-400">
        ...
        <div class="text-center pt-10 sm:pt-12 font-light flex items-center justify-center">
            ...
            <div class="text-center  text-slate-700 pt-10 sm:pt-12 font-light flex items-center justify-center">
                Copyright 2025 ©FruitShop
            </div>
        </div>
    </footer>
